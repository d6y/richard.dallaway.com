...
That's a 169 element array, representing the chromosome of an game player.

The "cartesian" in Cartesian Genetic Programming is there because CGP was initially a 2D grid of compute nodes.
